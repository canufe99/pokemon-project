const pokemonPopup = document.querySelector('.pokemon-popup');
const pokemonDetails = document.querySelector('.popup-content'); 
    ...
    pokeApi.getPokemons(offset, limit).then((pokemons = []) => {
        ...
        cards.forEach((card) => {
            card.addEventListener('click', () => {
                ...
                pokemonDetails.innerHTML = card.innerHTML;
